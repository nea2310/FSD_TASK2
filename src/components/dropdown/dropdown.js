		...
		switch($(this).attr('data-name')){
			case 'category-one':
				$(this).parent().parent().parent().parent().parent().children(".dropdown-header").children(".category-one-count").text(span.text());
					switch(Number(span.text())){
						case 1:
							$(this).parent().parent().parent().parent().parent().children(".dropdown-header").children(".category-one-name").text(cat1quant1.text());
							break;
						case 2:
						case 3:
						case 4:
							$(this).parent().parent().parent().parent().parent().children(".dropdown-header").children(".category-one-name").text(cat1quant2.text());
							break;
						default:
							$(this).parent().parent().parent().parent().parent().children(".dropdown-header").children(".category-one-name").text(cat1quant3.text());
							break;		
						}
			...
			case 'category-two':
				$(this).parent().parent().parent().parent().parent().children(".dropdown-header").children(".category-two-count").text(span.text());
					switch(Number(span.text())){
						case 1:
							$(this).parent().parent().parent().parent().parent().children(".dropdown-header").children(".category-two-name").text(cat2quant1.text());
							break;
						case 2:
						case 3:
						case 4:
							$(this).parent().parent().parent().parent().parent().children(".dropdown-header").children(".category-two-name").text(cat2quant2.text());
							break;
						default:
							$(this).parent().parent().parent().parent().parent().children(".dropdown-header").children(".category-two-name").text(cat2quant3.text());
							break;		
						}
				break;
			case 'category-three':
				$(this).parent().parent().parent().parent().parent().children(".dropdown-header").children(".category-three-count").text(span.text());
					switch(Number(span.text())){
						case 1:
							$(this).parent().parent().parent().parent().parent().children(".dropdown-header").children(".category-three-name").text(cat3quant1.text());
							break;
						case 2:
						case 3:
						case 4:
							$(this).parent().parent().parent().parent().parent().children(".dropdown-header").children(".category-three-name").text(cat3quant2.text());
							break;
						default:
							$(this).parent().parent().parent().parent().parent().children(".dropdown-header").children(".category-three-name").text(cat3quant3.text());
							break;		
						}
				break;		
			}
